...
namespace API.Controllers
{
    public class PaymentsController : BaseApiController
    {
        ...
        [HttpPost("webhook")]
        public async Task<ActionResult> StripeWebhook() //This is needed to communicate with Stripe back and fourth. Stripe will send an event to our API for the result of the payment
        {
